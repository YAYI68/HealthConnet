...
function AppointmentSchedule({step,setStep}) {
    const [ date , setDate ] = useState('')
    const [ time, setTime ] = useState('')
     
    const position = 0 - step
    ...
    <div style={{
        ...
        transition:'transform'
            ...
            <div className='text-center'>
                <p className='font-semibold lg:text-[1.5rem]'>Dr, Sunday Anderson</p>
                <small className='text-primary lg:text-[1rem]'>cardiologist</small>
            </div>
            ...
            <p className="text-[.8rem] flex items-center text-primary font-[500] w-full lg:w-4/6 lg:text-[1.2rem]">
            <span>
              <MdLocationPin />
            </span>{" "}
