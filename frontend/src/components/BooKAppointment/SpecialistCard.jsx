  ...
  return (
    ...
    >
      ...
      <div className="flex-1 basis-[70%] flex flex-col gap-2">
        <Link to={`/appointment/${doctor.slug}`} state={{id:doctor.uid}} className="text-primary  md:text-lg lg:text-xl font-[900] mt-2">
        ...
        <p className="text-primary font-semibold text-sm">{doctor.field}</p>
         <p className="text-primary font-semibold flex items-center text-sm"><TbCurrencyNaira /> <span>{doctor.price}</span></p>
        </div>
