...
export default function BookingPage() {
  ...
  return (
    <div className="w-full min-h-screen  relative flex flex-col items-center mx-auto">
      <div
        className={`w-full backdrop-blur-md bg-white/30 h-full absolute top-0 left-0 z-[5] ${
          toggle ? "block" : "hidden"
        }`}
        onClick={() => closeToggle()}
      ></div>
      <div
        className={`w-[90%] lg:w-[40%] rounded-md absolute top-[2%] md:top-[5%] left-1/2 -translate-x-1/2 z-[6] flex flex-col items-center ${
          toggle ? "block" : "hidden"
        } `}
      >
        <AppoimentSection
      ...
      <section className=" w-[95%] md:w-[80%] mx-auto p-2 md:p-6 mt-6">
        <div className="flex w-full flex-col bg-secondary rounded-md lg:flex-row lg:items-center p-4">
          <div className="w-full flex lg:justify-between flex-col md:flex-row p-4 gap-4 lg:items-center lg:w-[80%]">
            ...
            <div className="w-full text-[1.5rem] md:w-[50%] md:flex md:flex-col md:gap-2">
              <p className="text-[1.2rem] md:text-[1.5rem] font-semibold w-full">
                Dr, {doctor.firstname} {doctor.lastname}
              </p>
              <p className="text-[.8rem] sm:text-[1rem] lg:text-[1.2rem]">
                {doctor.field}
              </p>
              <div className="flex">
                <p className="text-primary font-semibold text-[1rem] md:text-[1.2rem]">
                  # 5000
                </p>
              </div>
              <div className="flex w-full gap-2 lg:gap-4">
                <div className=" flex items-center bg-secondary p-1 rounded-md">
                  ...
                  <p className="flex flex-col justify-center items-center text-xs sm:text-[1rem] ">
                    {" "}
        ...
        before:bg-primary before:bottom-0 mb-4 w-fit"
            ...
            <button
              type="button"
              className="text-primary hover:underline self-end mt-4"
            >
              see all
            </button>
          </div>
