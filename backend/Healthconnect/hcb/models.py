...
class Patient (models.Model):
    ...
    marital_status = models.CharField(
        max_length=20, choices=Patient_MaritalStatus, null=True, blank=True)
...
class Doctor(models.Model):
    ...
    def appointments(self, status=None):
        if status != None:
            appointment = self.doctor_appointment.filter(
...
class Appointment(models.Model):
    ...
    doctor = models.ForeignKey(
        Doctor, on_delete=models.SET_NULL, null=True, related_name='doctor_appointment')
    patient = models.ForeignKey(
        Patient, on_delete=models.SET_NULL, null=True, related_name='patient_appointment')
    status = models.CharField(
        max_length=10, choices=AppointmentStatus, default='PENDING', null=True, blank=True)
...
class Review(models.Model):
    id = models.UUIDField(default=uuid.uuid4, unique=True,
                          primary_key=True, editable=False)
    doctor = models.ForeignKey(
        Doctor, on_delete=models.SET_NULL, null=True, related_name='doctor_reviews')
    patient = models.ForeignKey(
        Patient, on_delete=models.SET_NULL, null=True, related_name='patient_reviews')
...
class Blog(models.Model):
    ...
    image = models.ImageField(
        upload_to='blog', null=True, blank=True, default='default.jpg')
